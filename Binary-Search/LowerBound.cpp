...
/**************************************************************************************************************************************/
int firstValueGreater(vector<int> vi, int target){

	/**find the leftmost value that is greater than or equal to target **/
...
void solve(){
	vector<int> vi = {2,3,5,6,8,10,12};
	int target = 4;
	cout << firstValueGreater(vi, 4) << ln;
}
int main() {
